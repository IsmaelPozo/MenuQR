...
export function SettingsForm({ restaurant }: SettingsFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("[v0] Updating restaurant settings:", { name, phone, address, defaultLanguage })
      ...
      const errorMessage = error instanceof Error ? error.message : "Error al actualizar la configuración"
