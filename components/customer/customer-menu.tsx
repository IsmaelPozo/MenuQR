            ...
            {categories.map((category) => {
              ...
              return (
                <div key={category.id} id={`category-${category.id}`} className="scroll-mt-32">
                  <h2 className="text-2xl md:text-3xl font-bold mb-6">{category.name.es}</h2>
                        ...
                        <Card key={item.id} className="overflow-hidden hover:border-primary/50 transition-colors">
                          <div className="p-5 md:p-6">
                            <div className="flex items-start justify-between gap-4 mb-3">
                              <div className="flex-1 min-w-0">
                                <h3 className="text-lg font-semibold mb-1 truncate">{item.name.es}</h3>
                                {item.description && item.description.es && (
                                  <p className="text-sm text-muted-foreground line-clamp-2 mb-2">{item.description.es}</p>
                                )}
